...
class SimulationControl:
    ...
    def init_logging(self):
        ...
        self.log_file = os.path.join(self.log_dir, f"{self.timestamp}_FitnessScores.csv")
        with open(self.log_file, mode="w", newline="") as file:
            writer = csv.writer(file)
            writer.writerow(["Generation", "Individual", "Fitness"])

    def log_fitness(self, generation, solution, fitness):
        """Log the fitness score to the CSV file."""
